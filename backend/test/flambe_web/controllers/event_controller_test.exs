...
defmodule SteadyWeb.EventControllerTest do
  ...
  @create_end_attrs %{phase: "E", timestamp_integer: 1_509_092_447_708, message: ""}
  ...
  describe "create end event" do
    test "renders event when data is valid", %{conn: conn} do
      ...
      {:ok, %Activity{id: activity_id}} =
        Traces.create_activity(main_thread.id, %{
          name: "my little activity",
          description: "my little description of my little activity"
        })
